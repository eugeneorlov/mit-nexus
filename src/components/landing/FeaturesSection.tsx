      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-[#1E293B]">
            ...
            <em className="italic text-amber-500">launchpad.</em>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          {features.map((feature) => {
            ...
            return (
              <div
                key={feature.title}
                className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200 hover:shadow-md hover:border-amber-200 transition-all duration-300"
              >
